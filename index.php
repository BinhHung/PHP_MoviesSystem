        ...
        <div class="section-title">
            ...
            <form action="index.php" method="post">
              ...
              <div class="col-lg-1 col-md-6 d-flex">
                  <div class="form-group" style="margin-left: 10px;">
                      <input type="submit" name="btnCancel" value="Cancel" class="btn btn-secondary">
                  </div>
              </div>
          ...
          <?php
             ...
             if(isset($_POST['btnSearch'])){
              ...
              if (!empty($movie_search)) {
                  $sql .= " AND movies.title LIKE '%$movie_search%'";
              }
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              ...
              <div class="member-info">
                <h4>
                    <?php 
                        echo strlen($data['title']) > 30 ? wordwrap($data['title'], 30, "<br>", true) : $data['title'];
                    ?>
                </h4>
                <span><?= $data['catname'] ?></span>
            </div>
