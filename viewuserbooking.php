  ...
  <div class="col-lg-12">
     ...
     <table class="table">
      ...
      if(isset($_POST['btnsearch'])){
        ...
        where booking.bookingdate between '$start' AND '$end' and booking.status = '$status' and booking.userid = '$uid'";
...
if(isset($_GET['bookingid'])){
  ...
  if(mysqli_query($con,$sql)){
    ...
    echo "<script> window.location.href='viewuserbooking.php';  </script>";
  }else{
